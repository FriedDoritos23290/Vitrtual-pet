...
class FoodMenu:
    def __init__(self, game):
        ...
        self.items = [Food("Мясо", 30, 'images/food/meat.png', 10),
                      ...
                      Food(" Элитный Корм", 40, 'images/food/dog food elite.png', 25, medicine_power=2),
...
class Toy(pg.sprite.Sprite):
    def __init__(self):
        ...
        toys = ["images/toys/red bone.png", "images/toys/ball.png", "images/toys/blue bone.png"]

        self.image = pg.image.load(random.choice(toys))

        self.image = pg.transform.scale(self.image, (TOY_SIZE, TOY_SIZE))

        self.rect = self.image.get_rect()
        self.rect.topleft = (random.randint(0, SCREEN_WIDTH // 2), 0)
